...
export const DeviceLockScreen: React.FC<DeviceLockScreenProps> = ({
  ...
  // Listen for physical keyboard events (promoter laptop/keyboard)
  useEffect(() => {
  ...
  }, [enteredPin, cleanTarget, targetLength]);
